...
import AvailableStores from "@/components/admin/add-drop-store/AvailableStores";
import Overview from "@/components/admin/add-drop-store/Overview";
    ...
    <>
      ...
      <div className="my-2">
        <div className="w-full bg-white">
          <ul className="flex">
            <li
              className={`border border-gray-400 rounded-lg mx-3 px-2 py-1 hover:bg-gray-300 hover:cursor-pointer ${currentFilter === "All" ? "bg-gray-300" : ""}`}
              onClick={() => setCurrentFilter("All")}
            >
              All
            </li>
            <li
              className={`border border-gray-400 rounded-lg mx-3 px-2 py-1 hover:bg-gray-300 hover:cursor-pointer ${currentFilter === "Pending Requests" ? "bg-gray-300" : ""}`}
              onClick={() => setCurrentFilter("Pending Requests")}
            >
              Pending Requests
            </li>
            <li
              className={`border border-gray-400 rounded-lg mx-3 px-2 py-1 hover:bg-gray-300 hover:cursor-pointer ${currentFilter === "Approved Stores" ? "bg-gray-300" : ""}`}
              onClick={() => setCurrentFilter("Approved Stores")}
            >
              Approved Stores
            </li>
            <li
              className={`border border-gray-400 rounded-lg mx-3 px-2 py-1 hover:bg-gray-300 hover:cursor-pointer ${currentFilter === "Rejected Stores" ? "bg-gray-300" : ""}`}
        ...
        <AvailableStores stores={filterStores()} currentFilter={currentFilter} />
      </div>
    </>
  );
};
