...
const FoodCategory = ({ params })  => {
    ...
    useEffect(() => {
      const fetchVendors = async () => {
        try {
          const response = await axios.post("https://citikartt.com/api/vendor/fetch-all-vendors");
    ...
    selectedCampus === "All"
      ? vendorsData.filter((vendor) => params.category === vendor.category && (isDevelopment || vendor.name !== "test"))
      : vendorsData.filter(
          (vendor) =>
